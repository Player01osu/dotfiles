...
swayimg.viewer.limit_preload(4)                  -- number of images to preload
...
swayimg.viewer.on_key("0", swayimg.viewer.reset)
swayimg.viewer.on_key("Ctrl+C", function()
	os.execute("wl-copy " .. swayimg.viewer.get_image().path)
end)
