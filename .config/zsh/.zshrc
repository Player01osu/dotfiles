...
alias n="nsxiv . -t"
alias nshufa="fd --type=file --extension=jpg --extension=png --extension=jpeg --extension=gif | shuf | nsxiv -iat"
alias nshuf="fd --max-depth=1 --type=file --extension=jpg --extension=png --extension=jpeg --extension=gif | shuf | nsxiv -iat"
